...
#define AUDIO_MUTE_ON() 					HAL_GPIO_WritePin(AUDIO_MUTE_PORT, AUDIO_MUTE_PIN, GPIO_PIN_SET)
#define AUDIO_MUTE_OFF() 					HAL_GPIO_WritePin(AUDIO_MUTE_PORT, AUDIO_MUTE_PIN, GPIO_PIN_RESET)
#endif
